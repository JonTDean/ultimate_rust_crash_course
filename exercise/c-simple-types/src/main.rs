...
fn main() {
    ...
    //
    // - [ x ] Make a library file (src/lib.rs)
    // - [ x ] Move all the functions (except main) into the library
    // - [ x ] Make all the functions public with `pub`
    // - [ x ] Bring all the functions into scope using use statements. Remember, the name of the library

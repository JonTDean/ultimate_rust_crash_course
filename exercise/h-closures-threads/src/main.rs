...
fn main() {
    ...
    // Literally have no idea how to do this. Need to research more about threads and channels
    // Need to also check to see how to properly grab the `Result<i32, Err>`.
    // Focus on:
    // Receiver Channels
    // Sender Channels
    // .join().unrwap()
